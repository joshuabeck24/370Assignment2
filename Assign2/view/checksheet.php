...
<div style="margin-top:100px" id="wrapper">
		...
		<table border="1" width="100%" style="background-color:#e7e7e7;">
			...
			<tr><td class="indent2">i.	Text file with one line per quote.</td><td>&nbsp;</td><td>YES &nbsp;</td></tr>
			<tr><td class="indent2">ii.	Upload gives error if not a text file.</td><td>&nbsp;</td><td>YES &nbsp;</td></tr>
			<tr><td class="indent2">iii. Link on File Management page to see the current Quote File.</td><td>You may also view contents by mousing over link&nbsp;</td><td>YES &nbsp;</td></tr>
			...
			<tr><td></td><td>&nbsp;</td><td>&nbsp;</td></tr>
			<tr><td>10.	Provide a mechanism to delete unwanted image files.</td><td>&nbsp;</td><td>N/A &nbsp;</td></tr>
...
time by the user.</td><td>&nbsp;</td><td>N/A &nbsp;</td></tr>
			<tr><td>12.	Include a "Remember Me" checkbox on e-mail signup page.</td><td>&nbsp;</td><td>N/A &nbsp;</td></tr>
			<tr><td class="indent1">a.	Include a "Welcome First Name" in header if they wanted to be remembered on that machine.</td><td>&nbsp;</td><td>N/A &nbsp;</td></tr>
...
appropriate message indicating this.</td><td>&nbsp;</td><td>N/A &nbsp;</td></tr>
			<tr><td>14.	Allow multi-file selection of images in the upload.</td><td>&nbsp;</td><td>N/A &nbsp;</td></tr>
		</tbody></table>
